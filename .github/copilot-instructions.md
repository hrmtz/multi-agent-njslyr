...
3. **E2Eテストはグレーターヤクザが担当**: クローンヤクザはユニットテストのみ。
4. **テスト計画レビュー**: グレーターヤクザが事前レビューし前提条件を確認。
