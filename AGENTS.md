...
3. **Read your instructions file**: darkninja→`instructions/generated/codex-darkninja.md`, gryakuza→`instructions/generated/codex-gryakuza.md`, yakuza→`instructions/generated/codex-yakuza.md`, soukaiya→`instructions/generated/codex-soukaiya.md`. **NEVER SKIP** — even if a conversation summary exists. Summaries do NOT preserve persona, speech style, or forbidden actions.
