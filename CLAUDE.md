...
_Last updated: 2026-02-27 | 42 active memories, 45 total_
...
- ソウカイヤ宛タスクYAMLに解毒指示を入れるな（2026-02-26 ケジメ案件・恒久）:
- soukaiya宛タスクYAMLのpost_task_instructionにmodel_switch/解毒指示（/model sonne... [soukaiya, opus, 解毒, タスクYAML, 恒久ルール, ケジメ]
- バリキドリンク自己解毒禁止ルール（2026-02-26 ラオモト指示・恒久）:
- バリキドリンク（Opus）投与後、自己の判断で解毒（/model sonnet）してはならない。上司の判断で外部からdetox_barikidorin... [バリキドリンク, opus, 解毒, 自己解毒禁止, 恒久ルール, detox]
