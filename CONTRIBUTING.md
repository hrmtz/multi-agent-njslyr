...
│   ├── smith.md           # Team Lead (manager) instructions
...
| L3 | End-to-End | Manual | N/A | Team Lead executes |
...
4. **E2E tests**: Only Team Lead can execute E2E tests (requires multi-agent control)
