...
@test "E2E-005-A: redo via /clear replaces task and produces new report" {
    ...
    cat > "$E2E_QUEUE/queue/tasks/yakuza1.yaml" <<'EOF'
task:
...
EOF
    ...
    assert_yaml_field "$E2E_QUEUE/queue/reports/yakuza1_report.yaml" "task_id" "subtask_test_001a2"
    ...
    assert_yaml_field "$E2E_QUEUE/queue/tasks/yakuza1.yaml" "task.redo_of" "subtask_test_001a"
}
